...
const KitComm = () => {
  ...
  return (
    <Layout userRole="student">
      <div className="kitcomm-container fade-in ">
        <div className="page-header">
          <h1 className="page-title">
            <i className="fas fa-cog"></i>
            KitComm – Live PED Chatroom
          </h1>
          <p className="page-subtitle">
            Secure communication platform for operational coordination.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This KitComm component is being converted from the original HTML page. 
