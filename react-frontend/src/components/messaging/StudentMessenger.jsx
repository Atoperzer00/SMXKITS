...
const StudentMessenger = () => {
  ...
  return (
    <Layout userRole="student">
      <div className="studentmessenger-container fade-in ">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Direct communication channel with instructors and support staff.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This StudentMessenger component is being converted from the original HTML page. 
