...
const MissionLinks = () => {
  ...
  return (
    <Layout userRole="student">
      <div className="missionlinks-container fade-in ">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Access live PED exercises and real-time mission scenarios for hands-on training.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This MissionLinks component is being converted from the original HTML page. 
