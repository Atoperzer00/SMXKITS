...
const IATraining = () => {
  ...
  return (
    <Layout userRole="student">
      <div className="iatraining-container fade-in ">
        <div className="page-header">
          <h1 className="page-title">
            <i className="fas fa-arrow-left"></i>
            IA Training - SMX KITS
          </h1>
          <p className="page-subtitle">
            Master intelligence analysis fundamentals and analytical methodologies.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This IATraining component is being converted from the original HTML page. 
