...
const AddStudent = () => {
  ...
  return (
    <Layout userRole="admin">
      <div className="addstudent-container fade-in admin-theme">
        <div className="page-header">
          <h1 className="page-title">
            <i className="fas fa-cog"></i>
            Add Student – SMX KITS
          </h1>
          <p className="page-subtitle">
            Add Student interface for the SMX KITS training system.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This AddStudent component is being converted from the original HTML page. 
