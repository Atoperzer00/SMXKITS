...
const UsersRoles = () => {
  ...
  return (
    <Layout userRole="admin">
      <div className="usersroles-container fade-in admin-theme">
        <div className="page-header">
          <h1 className="page-title">
            <i className="fas fa-cog"></i>
            Users & Roles – SMX KITS
          </h1>
          <p className="page-subtitle">
            Users Roles interface for the SMX KITS training system.
          </p>
        </div>
        ...
        <div className="content-placeholder">
          <div className="placeholder-card">
            ...
            <p>
              This UsersRoles component is being converted from the original HTML page. 
